...
local function setEditorTheme()
	...
	hl(
  	...
  	hl(
		...
		"DiffText",
		{
			fg = colors.derivatives.base3, 
			bg = colors.fixed.light_red
		}
	)
  	hl(
		0,
  	...
  	hl(
		...
		"Search",
		{
			fg = colors.fixed.light_red, 
			bg = colors.fixed.yellow
		}
	)
  	hl(
		0,
